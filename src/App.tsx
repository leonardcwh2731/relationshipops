...
function App() {
  ...
  const fetchPotentialValueMetrics = async () => {
    try {
      ...
      // For now, we'll set static values for drafted since this isn't in the schema
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {contacts.map((contact, index) => (
                    <tr key={contact.linkedin_profile_url || index} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-500">
                              {contact.last_interaction_platform || 'N/A'}
                            </div>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <div className="text-sm text-gray-900">
                          {contact.client_full_name || 'N/A'}
                        </div>
                        <div className="text-sm text-gray-500">
                          {contact.client_email || 'N/A'}
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <div className="flex items-center space-x-2">
